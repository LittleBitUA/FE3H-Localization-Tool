...
Байтові розкладки звірені з 010-шаблонами модерської спільноти
**[Three Houses Research Team](https://github.com/orgs/three-houses-research-team)**
(THRT). Серіалізатори покриті round-trip тестами: `parse → serialize` має відтворювати оригінал байт-у-байт.
...
Готові збірки з вбудованим Python — на сторінці
[Releases](https://github.com/LittleBitUA/FE3H-Localization-Tool/releases).
...
- Спільноті **[Three Houses Research Team](https://github.com/orgs/three-houses-research-team)** за 010-шаблони форматів і мапінг імен файлів.
